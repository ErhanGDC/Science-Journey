...
namespace ScienceJourney.ExceptionHandling
{
    ...
    {
        #region Singleton
        //Manager sınıfının içerisinde kullanılıcak olan formatter
        ...
        //Yapıcı ile dependency injection yapılır
        private ExceptionManager(IExceptionFormatter exceptionFormatter)
        {
            this.exceptionFormatter = exceptionFormatter;
        }
        //bu method standart double check singleton defualtta html kullanacak
